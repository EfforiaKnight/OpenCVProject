...
class OpticalFlowCalculator:
    ...
    def processFrame(self, frame, distance=None, timestep=1):
        ...
        if self.prev_gray != None:
            ...
            flow = cv2.calcOpticalFlowFarneback(self.prev_gray, gray, frame2, pyr_scale=0.5, levels=5, winsize=13,
...
if __name__ == "__main__":
    ...
    scaledown = int(options.scaledown) if options.scaledown else 2
